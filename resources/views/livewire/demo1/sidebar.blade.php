            ...
            <div class="kt-menu flex grow flex-col gap-1" data-kt-menu="true" data-kt-menu-accordion-expand-all="false"
                ...
                @if($role === 'SuperAdmin' || $role === 'Admin')
                    <div class="kt-menu-item">
                        <a data-kt-container-toggle="#usersContainer" class="kt-menu-link kt-menu-item-active:bg-accent/60 dark:menu-item-active:border-border kt-menu-item-active:rounded-lg hover:bg-accent/60 grow items-center gap-[14px] border border-transparent py-[8px] pe-[10px] ps-[10px] hover:rounded-lg">
                            ...
                            <span class="kt-menu-title text-m kt-menu-item-active:text-primary kt-menu-item-active:font-semibold kt-menu-link-hover:!text-primary font-normal text-foreground">Users</span>
                        </a>
                    </div>
                    <div class="kt-menu-item">
