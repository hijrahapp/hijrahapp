<div class="kt-modal hidden" data-kt-modal="true" id="interest_add_modal" wire:ignore.self>
            ...
            <div class="kt-modal-body p-5 flex flex-col gap-4">
                ...
                <div>
                    ...
                    <div class="mt-4">
                        ...
                        <input type="text" class="kt-input w-full" wire:model.defer="name" placeholder="Enter interest name" />
