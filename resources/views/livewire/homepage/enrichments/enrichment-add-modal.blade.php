<div class="kt-modal hidden" data-kt-modal="true" id="enrichment_add_modal" wire:ignore.self>
    <div class="kt-modal-content max-w-[800px] top-[5%]">
        ...
        <form wire:submit.prevent="save">
            ...
            <div class="kt-modal-footer flex gap-2 justify-end p-5">
                ...
                <button type="submit" class="kt-btn kt-btn-primary">Create Enrichment</button>
            </div>
        </form>
    </div>
</div>