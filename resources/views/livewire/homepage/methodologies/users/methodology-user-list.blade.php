<div class="kt-container-fixed kt-main-container" id="userListContainer">
    <div class="flex flex-wrap items-center gap-2 pb-4">
        <a href="{{ route('methodologies') }}" class="kt-btn kt-btn-outline flex items-center justify-center">
    ...
    <div class="kt-card kt-card-grid kt-card-div h-full min-w-full">
        <div class="kt-card-header flex justify-between items-center">
            <h3 class="kt-card-title">{{ $methodology->name }}</h3>
            ...
            <div class="kt-scrollable-x-auto">
                <table class="kt-table kt-table-border table-fixed w-full">
                    ...
                    <tbody>
                        ...
                        @empty
                            <tr>
                                <td colspan="5" class="text-center">No users have interacted with this methodology yet.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
