    ...
    <div class="kt-modal-content max-w-[800px] top-[10%]">
        ...
        <form wire:submit.prevent="save">
            <div class="kt-modal-body p-5 flex flex-col gap-4">
                ...
                <div>
                    <livewire:shared.components.textarea :label="'Description'" wire:model.defer="description" :required="true" :placeholder="'Enter module description'" :rows="3" :maxlength="200" />
                </div>
                @error('description')<span class="text-destructive text-xs">{{ $message }}</span>@enderror

                <div>
                    <livewire:shared.components.textarea :label="'Definition'" wire:model.defer="definition" :required="true" :placeholder="'Enter module definition'" :rows="3" />
                </div>
