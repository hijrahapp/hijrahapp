<div class="kt-modal hidden" data-kt-modal="true" id="change_password_modal" wire:ignore.self>
            ...
            <div class="kt-modal-body p-5 flex flex-col gap-4">
                <div>
                    ...
                    <label class="kt-input" x-data="{ show: false }">
                        <input type="password" :type="show ? 'text' : 'password'" class="kt-input w-full" wire:model="current_password" />
                ...
                <div>
                    ...
                    <label class="kt-input" x-data="{ show: false }">
                        <input type="password" :type="show ? 'text' : 'password'" class="kt-input w-full" wire:model="new_password" />
                        <button type="button" @click="show = !show" class="kt-btn kt-btn-sm kt-btn-ghost kt-btn-icon bg-transparent! -me-1.5 ms-2">
                            <template x-if="show">
                                <i class="ki-filled ki-eye-slash text-muted-foreground"></i>
                            </template>
                ...
                <div>
                    ...
                    <label class="kt-input" x-data="{ show: false }">
                        <input type="password" :type="show ? 'text' : 'password'" class="kt-input w-full" wire:model="confirm_password" />
                        <button type="button" @click="show = !show" class="kt-btn kt-btn-sm kt-btn-ghost kt-btn-icon bg-transparent! -me-1.5 ms-2">
                            <template x-if="show">
                                <i class="ki-filled ki-eye-slash text-muted-foreground"></i>
                            </template>
