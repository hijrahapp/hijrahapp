...
<meta content="Hijrah" name="twitter:title" />
...
<link href="{{ asset('/assets/media/app/logo.png') }}" rel="icon" sizes="32x32" type="image/png" />
<link href="{{ asset('/assets/media/app/logo.png') }}" rel="icon" sizes="16x16" type="image/png" />
<link href="{{ asset('/assets/media/app/logo.png') }}" rel="shortcut icon" />
